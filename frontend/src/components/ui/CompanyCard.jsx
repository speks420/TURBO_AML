...
import { formatStatus, formatRegNumber } from '../../utils/formatters';
    ...
    >
      <VStack align="start" spacing={2}>
        <HStack justifyContent="space-between" w="100%">
          ...
          <Badge colorScheme={formattedStatus === 'Active' ? 'green' : 'red'}>
            {formattedStatus}
          </Badge>
        </HStack>
        ...
        <Text fontSize="sm">Address: {address || 'Not available'}</Text>

        <Text fontSize="sm">Founded: {founded_date || 'Not available'}</Text>
      </VStack>
    </Box>
  );
};
